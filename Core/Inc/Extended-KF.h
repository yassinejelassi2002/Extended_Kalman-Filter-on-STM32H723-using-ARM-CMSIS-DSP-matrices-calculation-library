...
typedef void (*state_func_t)(const arm_matrix_instance_f32* x, const arm_matrix_instance_f32* u, float dt, arm_matrix_instance_f32* x_pred);
typedef void (*meas_func_t)(const arm_matrix_instance_f32* x, arm_matrix_instance_f32* z_pred);
typedef void (*jacobian_func_t)(const arm_matrix_instance_f32* x, const arm_matrix_instance_f32* u, float dt, arm_matrix_instance_f32* jacobian);
